...
public class MemDB {
    ...
    private static void init() throws ClassNotFoundException, SQLException {
        ...
        memDB.createTable(Table.MESSAGE,"(id INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1, INCREMENT BY 10) PRIMARY KEY, ham integer, spam integer)");
        //inserir els primers contadors
        memDB.insertFirstCounters();
