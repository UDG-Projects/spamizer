...
Primer de tot el que fem és declarar dues variables que ens serviràn per guardar tan la suma de probabilitats de cada paraula de que sigui spam o ham.
...
Tan la suma de probabilitats de cada paraula del missatge com la probabilitat del missatge de ser spam o ham, estàn logarimitzades, i per tant el que fem al final és sumar aquestes dades.
...
Finalment apliquem la fórmula amb phi quen ens permet donar importància al fet de  no classificar missatges Ham com a Spam, per tant com que volem estar segurs d'això fem el següent:
mirem que per classificar un missatge com a Spam, la probabilitat de ser spam ha de ser més gran que phi vegades la probabilitat de que sigui ham.
...
Si ens basem en el temps, hem vist que el fet d'utilitzar el filtre amb la llibreria Stanford Core NLP, augmenta consedrablement, parlem de l'ordre de 100 vegades més lent que si no utilitzem un filtratge de paraules.
...
Les notres millors execucions mostren un TCR de fins 57 amb accuracy del 99%, desprès de fer moltissimes execucions per afinar un valor de phi i k.
