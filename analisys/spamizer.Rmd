...
[Spamizer on Github](https://github.com/UDG-Projects/spamizer)
...
```{r eval=FALSE}
-o -n 1 -c  -a "/home/marc/Escriptori/test/all/SPAM_TRAINING" "/home/marc/Escriptori/test/all/HAM_TRAINING"
```
...
```{r eval=FALSE}
java -jar spamizer.jar -l -n 1 -c  -a "/home/marc/Escriptori/test/all/SPAM_TRAINING" "/home/marc/Escriptori/test/all/HAM_TRAINING"
```
...
```{r eval=FALSE}
java -jar spamizer.jar -p -t "/home/marc/Escriptori/test/all/SPAM_TRAINING" "/home/marc/Escriptori/test/all/HAM_TRAINING"
```
...
```{r eval=FALSE}
java -jar spamizer.jar -n 10 -c "/home/marc/Escriptori/test/all/SPAM_TRAINING" "/home/marc/Escriptori/test/all/HAM_TRAINING"
```
...
```{r eval=FALSE}
java -jar spamizer.jar -o -l -n 10 -c "/home/marc/Escriptori/test/all/SPAM_TRAINING" "/home/marc/Escriptori/test/all/HAM_TRAINING"
```
